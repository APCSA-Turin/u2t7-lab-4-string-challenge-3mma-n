...
public class StringProblems{
    ...
    public String deFront(String s1){
        String ltr1 = s1.substring(0, 1);
        String ltr2 = s1.substring(1, 2);
        if (ltr1.equals("a") && ltr2.equals("b")) {
            return s1;
        }
        else if (ltr1.equals("a")) {
            return ltr1 + s1.substring(2);
        }
        else if (ltr2.equals("b")) {
    ...
    public String withoutX(String s1){
        boolean firstX = s1.substring(0, 1).equals("x");
        boolean lastX = s1.substring(s1.length() - 1).equals("x");
        if (firstX) {
            s1 = s1.substring(1);
        }
        if (lastX) {
